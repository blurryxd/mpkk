  ...
  render() {
    return this.props.picArray.map((picArr, i) => (
          ...
          <Card className={this.props.classes.card} key={i}>
              <CardMedia className={this.props.classes.media} image={'http://media.mw.metropolia.fi/wbma/uploads/' +
            ...
            <CardActions>
              <Button size="small" color="primary" component={Link} to={'/single/' + picArr.file_id}>
                View
              </Button>
            </CardActions>
          </Card>
